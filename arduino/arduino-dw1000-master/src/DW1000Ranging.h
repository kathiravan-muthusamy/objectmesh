...
public:
	...
	static void    startAsAnchor(char address[], const byte mode[],uint16_t addr);
	static void    startAsTag(char address[], const byte mode[],uint16_t addr);
	...
	static void attachTransmit(void (* handleTransmit)(void)) { _handleTransmit = handleTransmit; };
	...
	static DW1000Device* getDistantDeviceById(uint8_t deviceid);
...
private:
	...
	static void (* _handleTransmit)(void);
